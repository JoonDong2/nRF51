...
// NRF_SD_BLE_API_VERSION == 3일 때만 적용된다.
// S130은 MTU Exchange procedure 기능이 없기때문에 무용지물일 듯하다.
...
// <q> BLE_NDS_ENABLED  - ble_nds - Noise Detector Service


#ifndef BLE_NDS_ENABLED
#define BLE_NDS_ENABLED 1
#endif
